                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4 class="card-title">Edit Lpj</h4>

                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('lpj.update', $lpj->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group @error('periode') ? has-error @enderror has-feedback">
                                        ...
                                        <select class="form-control" name="periode" id="periode">
                                            ...
                                            <option {{ $lpj->periode == '2022 - 2023' ? 'selected' : null }}
                                    ...
                                    <div class="form-group @error('role') ? has-error @enderror has-feedback">
                                        ...
                                        <select class="form-control" name="role_id" id="role">
                                            ...
                                            @foreach ($roles as $role)
                                                <option {{ $lpj->role_id == $role->id ? 'selected' : null }}
                                    ...
                                    <div class="form-group  @error('judul') ? has-error @enderror has-feedback">
                                        ...
                                        <input type="text" name="judul" id="judul" class="form-control"
                                            value="{{ $lpj->judul }}" placeholder="ex. LPJ Kegiatan .....">
                                        @error('judul')
                                            <small class="form-text text-muted">
                                                {{ $message }}
                                            </small>
                                    ...
                                    <div class="form-group  @error('lpj') ? has-error @enderror has-feedback">
                                        ...
                                        <input type="hidden" name="old_lpj" value="{{ $lpj->lpj }}">
                                        @error('lpj')
                                            <small class="form-text text-muted">
                                                {{ $message }}
                                            </small>
